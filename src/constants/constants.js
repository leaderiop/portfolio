export const projects = [
  {
    title: 'Tanglass ERP',
    description: "Tanglass ERP is full functional Enterprise Resource Planningbuilt in from scrach using GraphQl Hasura and Angular With Matrial Design.",
    image: '/images/covid.jpg',
    tags: ['Angular', 'Ngrx', "RxJs","Material","Apollo",'nrwl','nx', 'GraphQl',"Auth0"],
    source: 'https://github.com/cloudvision-ma/tanglass-erp.git',
    visit: 'https://tanglass.almechkor.com/',
    id: 0,
  },
  {
